...
bool lessThanById(const Company &a, const Company &b) { return a.getId() < b.getId(); }

bool lessThanByName(const Company &a, const Company &b) { return a.getName() < b.getName(); }
