...
public:
    ...
    Company(std::string name, std::vector<std::pair<char, char>> employees) : name(name), employees(employees) {}

    std::string getName() const { return this->name; }

    std::vector<std::pair<char, char>> getEmployees() const { return this->employees; }
