...
static void populatePageData(VirtualBook &book, const std::vector<PageData> &pagesData) {
...
static void processCommands(VirtualBook &book, const std::vector<std::string> &commands) {
