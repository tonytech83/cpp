...
public:
    ...
    void add(const std::shared_ptr<FileSystemObject> &obj) override { this->items.push_back(obj); }

    std::vector<std::shared_ptr<FileSystemObject>>::const_iterator begin() const override {
        return this->items.begin();
    }

    std::vector<std::shared_ptr<FileSystemObject>>::const_iterator end() const override { return this->items.end(); }
