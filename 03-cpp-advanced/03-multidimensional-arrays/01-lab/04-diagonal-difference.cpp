...
auto secondaryDiagonalSum(const vector<vector<int>> &matrix, const int size) -> int {
    int sum = 0;
...
auto main() -> int {
    ...
    cout << abs(primaryDiagonalSum(squareMatrix, N) - secondaryDiagonalSum(squareMatrix, N)) << endl;
    return 0;
}
